...
ただし笑いは**暗い事実を淡々と述べることで自然に生まれる**もの(例:過酷な生態を役所・労働・日常に例える)。
...
- 笑いの作り方: 誇張やボケではなく、**暗い/過酷な事実を、あえて淡々と、日常語(労働・制度・生活)に置き換える**。
  例:絶食→「やる気の最小値で、生きています」/長い子育て→「労働基準法も、届かないようです」。品よく、毒は薄く。
