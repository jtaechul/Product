...
export const STAGE_WALLS = [
  ...
  { id: 'w02', level: 1, pose: 'stand',  rot: 0,     margin: 0.52, approachSpeed: 1.0, variant: 'normal' },
  { id: 'w03', level: 1, pose: 'tpose',  rot: 0,     margin: 0.56, approachSpeed: 1.0, variant: 'normal' },
  { id: 'w04', level: 1, pose: 'tpose',  rot: 0,     margin: 0.48, approachSpeed: 1.05, variant: 'normal' },
  { id: 'w05', level: 2, pose: 'oneup',  rot: 0,     margin: 0.52, approachSpeed: 1.05, variant: 'normal' },
  { id: 'w06', level: 2, pose: 'stand',  rot: -0.32, margin: 0.50, approachSpeed: 1.1, variant: 'normal' },
  { id: 'w07', level: 2, pose: 'stand',  rot: 0.32,  margin: 0.48, approachSpeed: 1.1, variant: 'normal' },
  ...
  { id: 'w09', level: 3, pose: 'crouch', rot: 0,     margin: 0.52, approachSpeed: 1.15, variant: 'normal' },
  // ── 스테이지 2: 성장 ──
  { id: 'w10', level: 3, pose: 'tpose',  rot: 0,     margin: 0.44, approachSpeed: 1.2, variant: 'normal' },
  { id: 'd02', level: 3, pose: 'bangbang', rot: 0,   margin: 0.52, approachSpeed: 1.2, variant: 'normal', title: '뱅뱅', artist: '아이브' },
  { id: 'w11', level: 4, pose: 'oneup',  rot: 0,     margin: 0.46, approachSpeed: 1.25, variant: 'normal' },
  { id: 'w12', level: 4, pose: 'star',   rot: 0,     margin: 0.44, approachSpeed: 1.25, variant: 'normal' },
  { id: 'w13', level: 4, pose: 'stand',  rot: -0.5,  margin: 0.46, approachSpeed: 1.3, variant: 'normal' },
  { id: 'd03', level: 4, pose: 'itsme',  rot: 0,     margin: 0.52, approachSpeed: 1.25, variant: 'normal', title: "it's me", artist: '아일릿' },
  { id: 'w14', level: 5, pose: 'crouch', rot: 0,     margin: 0.46, approachSpeed: 1.3, variant: 'normal' },
  { id: 'w15', level: 5, pose: 'star',   rot: 0,     margin: 0.40, approachSpeed: 1.35, variant: 'rotate' },
  { id: 'w16', level: 5, pose: 'stand',  rot: 0.5,   margin: 0.44, approachSpeed: 1.35, variant: 'normal' },
  { id: 'd04', level: 5, pose: 'cat',    rot: 0,     margin: 0.52, approachSpeed: 1.3, variant: 'normal', title: '빌려온 고양이', artist: '아일릿' },
  { id: 'w17', level: 6, pose: 'tpose',  rot: 0,     margin: 0.40, approachSpeed: 1.4, variant: 'normal' },
  // ── 스테이지 3: 결전 (빠르고 변형 多) ──
  { id: 'w18', level: 6, pose: 'oneup',  rot: 0,     margin: 0.42, approachSpeed: 1.45, variant: 'moving' },
  { id: 'w19', level: 6, pose: 'crouch', rot: 0,     margin: 0.42, approachSpeed: 1.45, variant: 'normal' },
  { id: 'd05', level: 6, pose: 'afterlike', rot: 0,  margin: 0.50, approachSpeed: 1.4, variant: 'normal', title: '에프터라이크', artist: '아이브' },
  { id: 'w20', level: 7, pose: 'star',   rot: 0,     margin: 0.38, approachSpeed: 1.5, variant: 'rotate' },
  { id: 'w21', level: 7, pose: 'stand',  rot: -0.55, margin: 0.40, approachSpeed: 1.5, variant: 'normal' },
  { id: 'w22', level: 7, pose: 'tpose',  rot: 0,     margin: 0.38, approachSpeed: 1.55, variant: 'normal' },
  { id: 'd06', level: 7, pose: 'magnet', rot: 0,     margin: 0.48, approachSpeed: 1.45, variant: 'normal', title: '마그넷', artist: '아일릿' },
  { id: 'w23', level: 8, pose: 'crouch', rot: 0,     margin: 0.40, approachSpeed: 1.55, variant: 'normal' },
  { id: 'w24', level: 8, pose: 'star',   rot: 0,     margin: 0.36, approachSpeed: 1.6, variant: 'rotate' },
