...
from src.sample_data import generate_synthetic_ohlcv  # noqa: E402
...
def load_data(market: str, count: int = 200):
    ...
    try:
        ...
        pass
    return generate_synthetic_ohlcv(days=count), False
...
account = run_paper_trading(df, strategy_fn, initial_cash=cash)
