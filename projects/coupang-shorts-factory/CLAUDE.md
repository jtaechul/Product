...
- **채널 정체성 (2026-07-12 확정)**: 표시명 "미래상점 Futuremarket" / 핸들 `@miraemarket` /
  컨셉 "미래에서 온 큐레이터가 오늘 당장 살 수 있는 신박한 미래템을 소개"(미래화자 톤).
  니치 **신박한 가젯·아이디어 상품**(자취·주방·데스크·여행/캠핑 소형템), 타깃 20~30대 1인가구.
  **영상에 가격 미표기**(링크 클릭 유도 + 가격변동·허위 리스크 회피) — 대본은 훅·입담·신랄한
  페인포인트 중심(`config/prompts/script_gen.md`, 금액은 `sanitize.py`가 자동 차단).
