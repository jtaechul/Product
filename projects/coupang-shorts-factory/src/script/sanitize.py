...
CHAR_MIN, CHAR_MAX = 135, 170   # 본문(훅 카드 제외) 공백 제외 — 2026-07-19 사용자 확정: 영상은 무조건
                                # 20초를 넘어야 한다(110자 하한 때 실측 낭독이 20초 아래로 떨어짐 → 상향).
                                # 135자 + 훅 ≈ 23초. 렌더 엔딩 홀드·QA 20초 게이트가 2·3차 방어.
