...
_FIELD_SPEC = {
    ...
    "thumb_hook": "0:00 훅 카드 문구 — 이 문장이 곧 유튜브 제목이 되고, 나레이션 첫마디로 이 문장을 그대로 읽는다(포맷 v2). 공백 포함 12~25자, 1~2줄. ⭐ 과녁은 '이 제품의 가장 신박한 한 가지'(2026-07-20): 확정 차별점이 만든 결과·상황을 호기심 문장으로(예: '이 이불 덮고 에어컨 껐다'). 스펙·기능 명칭·수치 나열 금지('12단 냉감 원단' 같은 문구 실패). 뜬구름·정체불명 문구 금지, 구체적으로. 브랜드·정식 제품명·가격·타깃 서술어(자취 등) 금지",
