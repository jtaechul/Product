...
_FIELD_SPEC = {
    "title": "유튜브 제목 = thumb_hook과 완전히 동일한 문장(포맷 v2 삼위일체, 2026-07-18 — 시스템이 훅으로 자동 통일). 공백 포함 12~25자. ⭐ 훅 공식(2026-07-27): 페인 뚜렷하면 '[타깃이 내 얘기로 느끼는 상황]+[구체 페인]+[반전 암시]'(A형), 신박함이 무기면 '이게 된다고?' 호기심(B형). '주목!'류 명령 금지·경험 거울 어법으로. 주거·인구 라벨(자취·원룸·1인가구) 금지 / 상황 호명('아기 태우면~')은 권장. 브랜드·정식 제품명·가격 금지",
    "headline": "영상 상단 뉴스 헤드라인 — 폭로 기사 제목 톤(문어체), 제품명 감춤, 12~22자",
    "thumb_hook": "0:00 훅 카드 문구 = 유튜브 제목 = 나레이션 첫마디(삼위일체). 공백 포함 12~25자, 1~2줄. ⭐ 과녁=훅 공식 A/B/C 자동선택(2026-07-27): 페인 뚜렷하면 A '[타깃이 내 얘기로 느끼는 상황]+[구체 페인]+[반전 암시]'(예: '아기 태우고 백미러만 힐끔대다 아찔했다면 이거 하나로 끝'), 신박함이 무기면 B 호기심('이 이불 덮고 에어컨 껐다'). '주목!'류 명령 금지·경험 거울로. 스펙·기능 명칭·수치 나열 금지('12단 냉감 원단' 실패). 정체불명 문구 금지·구체적으로. 브랜드·정식 제품명·가격·주거 라벨(자취 등) 금지",
