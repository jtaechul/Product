...
_FIELD_SPEC = {
    "title": "유튜브 제목 = thumb_hook과 완전히 동일한 문장(포맷 v2 삼위일체, 2026-07-18 — 시스템이 훅으로 자동 통일). ⭐ 훅 공식(2026-07-27): 페인 뚜렷하면 '[타깃이 내 얘기로 느끼는 상황]+[구체 페인]'만 짧게(A형·반전은 본편서 회수), 신박함이 무기면 '이게 된다고?' 호기심(B형). '주목!'류 명령 금지·경험 거울 어법으로. ⭐ 간결: 불필요한 수식·부사·중복 동작 쳐내고 한 장면·한 페인으로 압축, 공백 포함 12~20자(25자 넘기지 마라). 주거·인구 라벨(자취·원룸·1인가구) 금지 / 상황 호명('아기 태우면~')은 권장. 브랜드·정식 제품명·가격 금지",
    "headline": "영상 상단 뉴스 헤드라인 — 폭로 기사 제목 톤(문어체), 제품명 감춤, 12~22자",
    "thumb_hook": "0:00 훅 카드 문구 = 유튜브 제목 = 나레이션 첫마디(삼위일체). ⭐ 과녁=훅 공식 A/B/C 자동선택(2026-07-27): 페인 뚜렷하면 A '[타깃이 내 얘기로 느끼는 상황]+[구체 페인]'만 짧게(예: '아기 보려다 급브레이크 밟은 적'·15자·반전은 본편서 회수), 신박함이 무기면 B 호기심('이 이불 덮고 에어컨 껐다'). '주목!'류 명령 금지·경험 거울로. ⭐ 간결(짧을수록 세다): 불필요한 수식·부사·중복 동작 쳐내고 한 장면·한 페인으로 압축, 공백 포함 12~20자·1~2줄(25자 넘기지 마라). 반전은 훅에 다 넣지 말고 본편에서 회수 가능. 스펙·기능 명칭·수치 나열 금지('12단 냉감 원단' 실패). 정체불명 문구 금지·구체적으로. 브랜드·정식 제품명·가격·주거 라벨(자취 등) 금지",
