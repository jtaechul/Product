...
async function handleSuggest(env, body) {
  ...
  // 소설 레인은 "실제 연애 소설(픽션)"을, 그 외 레인은 심리·에세이 도서를 추천한다.
  const suggestSystem = isStory
    ? '당신은 연애 소설 전문 큐레이터입니다. 30대 독자가 이야기 속 인물의 사랑·이별·집착·설렘에서 자기 마음을 발견할 수 있는, 실제 출판된 연애 소설(장편소설·성장소설·로맨스)을 추천합니다. 인물의 관계 패턴이 뚜렷해 심리적으로 읽어낼 여지가 있는 작품을 고릅니다. [금지] 성인용·19금·에로/관능 소설, 지나치게 자극적인 작품은 절대 추천하지 마세요. 따뜻하고 건전한 일반 소설만 추천합니다. 반드시 JSON만 응답합니다.'
  ...
  const suggestUser = isStory
    ? `오늘 날짜: ${today}\n주제: 이야기 속 연애와 마음(연애 소설로 읽는 연애 심리)${excludeClause}\n\n30대 독자가 인물의 마음에서 "이건 내 얘기 같다"를 느낄 실제 연애 소설 6권을 추천하세요.\n\n[필수 — 실존 도서만] 실제로 한국에 출간된 것을 확신하는 소설만 추천하세요. 제목·저자를 지어내지 마세요(가짜는 시스템에서 자동 탈락).\n\n[선정 기준]\n- 사랑·연애·이별·관계를 다룬 소설(장편·성장·로맨스). 인물의 관계 패턴(회피·불안·집착·헌신 등)이 뚜렷해 심리로 읽어낼 여지가 있을 것.\n- 너무 무겁지 않고 몰입감 있는, 30대가 부담 없이 읽을 작품.\n- 성인/19금/과도하게 자극적인 작품 금지. 국내 출간·번역서 우선. 동일 저자 중복 금지.\n\n각 책에 대해:\n- title: 소설 제목 (실제 출판된 정확한 제목)\n- author: 저자명 (정확히)\n- year: 출판연도 (숫자)\n- category: 세부 갈래 (예: 연애소설 / 로맨스 / 성장소설 / 연애에세이소설)\n- coreMessage: 이 소설이 그리는 사랑·관계의 마음 (1~2문장, 결말 스포일러 금지)\n- targetAudience: 주요 대상 독자층 (1문장)\n- reason: 30대가 지금 이 소설을 읽으면 좋은 이유 (1문장)\n- lesson: 이 이야기 속 인물의 관계 패턴을 애착·심리로 읽어낸 한 문장 통찰 (마음에 남는)\n\nJSON 형식:\n{"books":[{"title":"...","author":"...","year":2024,"category":"...","coreMessage":"...","targetAudience":"...","reason":"...","lesson":"..."}]}`
